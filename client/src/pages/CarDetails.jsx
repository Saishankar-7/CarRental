  ...
  return car ? (
    ...
    transition={{duration:0.6,delay:0.3}}
      ...
      className='shadow-lg h-max sticky top-18 rounded-xl p-6 space-y-6 text-gray-500'>
            ...
            text-gray-800 font-semibold'>{currency} {car.pricePerDay} <span className='text-base text-gray-500 font-normal'> per day</span></p>
          <hr className='border-borderColor my-6' />
          ...
          <button type='submit' className='w-full bg-primary hover:bg-primary-dull
