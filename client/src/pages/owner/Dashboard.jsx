...
const Dashboard = () => {
  ...
  return (
    <div className='px-4 pt-10 md:px-10 flex-1'>
      <Title title="Admin Dashboard" subtitle="Moniter overall platform performance
      ...
      <div className='flex flex-wrap item-start gap-6 mb-8 w-full'>
        <div className='p-4 md:p-6 border border-borderColor rounded-md max-w-lg w-full'>
          ...
          {data.recentBookings.map((booking,index)=>(
            <div key={index} className='mt-4 flex items-start justify-between'>
          ...
          <div className='p-4 md:pd-6 border border-borderColor rounded-md w-full md:max-w-xs'>
