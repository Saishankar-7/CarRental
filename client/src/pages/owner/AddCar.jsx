    ...
    <div className='px-4 py-10 md:px-10 flex-1'>
      ...
      className='flex flex-col gap-5 text-gray-500 text-sm mt-6 max-w-xl'>
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
            ...
            <div className='flex flex-col w-full'>
              <label >Model</label>
              <input type="text" placeholder='e.g. X5, M4,E-class' required 
              className='px-3 py-2 mt-1 border border-borderColor rounded-md outline-none'
          ...
          <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6'>
              <div className='flex flex-col w-full'>
              <label >Year</label>
              <input type="text" placeholder='e.g.2025'required 
              className='px-3 py-2 mt-1 border border-borderColor rounded-md outline-none'
          ...
          <div className='flex flex-col w-full'>
           ...
           <div className='flex flex-col w-full'>
              ...
              <textarea rows={5} placeholder='e.g. A luxurious SUV with a spacious interior and a powerfu engine.'required 
              className='px-3 py-2 mt-1 border border-borderColor rounded-md outline-none'
              value={car.description} onChange={(e)=>setCar({...car,description:e.target.value})}></textarea>
            </div>
          <button className='flex item-center gap-2 px-2 py-2.5 mt-4 bg-primary
