...
const Testimonial = () => {
    const testimonials = [
        ...
        {  name: "John Smith", location: "New York,USA", image: assets.testimonial_image_2, testimonial: "CarRental made my trip so much easier. The car was delivered right to my door , and the customer was fantastic!" },
        {  name: "Sophia Lee", location: "Seoul, South Korea", image: assets.testimonial_image_1, testimonial: "I was impressed by the wide selection of cars available at CarRental. I found the perfect car for my needs at a great price." },   
    ]
  return (
