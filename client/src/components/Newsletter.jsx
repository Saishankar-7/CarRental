  ...
  return (
    ...
    viewport={{once:true,amount:0.3}}>
        ...
        transition={{duration:0.5,delay:0.3}} 
            className="md:text-lg text-gray-500/70 pb-8">Subscribe to get the latest offers, new arrivals and exclusive discounts</motion.p>
            <motion.form 
            initial={{opacity:0,y:20}}
        whileInView={{opacity:1,y:0}}
        transition={{duration:0.5,delay:0.4}}
            className="flex items-center  justify-between   max-w-2xl w-full
            md:h-13 h-12">
                <input 
                    type="email" 
                    name="email"
                ...
                hover:bg-primary-dull transition-all cursor-pointer rounded-md rounded-1-none'>
                    Subscribe now
                </button>
            </motion.form>
        </section>
